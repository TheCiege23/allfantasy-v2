...
export default async function E2ERosterPage(props: {
  searchParams?:
  ...
  const leagueId = resolved.leagueId?.trim() || 'e2e-roster-league'

  return (
    <main className="min-h-screen bg-[#0a0a0f] p-6 text-white">
      <h1 className="mb-4 text-xl font-semibold">E2E Roster Harness</h1>
