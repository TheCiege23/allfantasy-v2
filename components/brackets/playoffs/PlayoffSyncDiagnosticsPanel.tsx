...
function safeDiagnostics(value: unknown) {
  ...
  return {
    ...
    finalScoreRowsMatchedBySeries: (record.diagnostics as any)?.finalScoreRowsMatchedBySeries,
    missingFinalScoreGamesBySeries: (record.diagnostics as any)?.missingFinalScoreGamesBySeries,
    partialSeriesWinCounts: (record.diagnostics as any)?.partialSeriesWinCounts,
    seriesStillPendingReasons: (record.diagnostics as any)?.seriesStillPendingReasons,
    ...
    scheduleSupplementProvider: (record.diagnostics as any)?.scheduleSupplementProvider,
    scheduleGamesSeen: (record.diagnostics as any)?.scheduleGamesSeen,
    scheduleGamesMatched: (record.diagnostics as any)?.scheduleGamesMatched,
    unmatchedScheduleExamples: (record.diagnostics as any)?.unmatchedScheduleExamples,
    dateOnlyNextGameExamples: (record.diagnostics as any)?.dateOnlyNextGameExamples,
    nextGameDateKnownButTimeMissing: (record.diagnostics as any)?.nextGameDateKnownButTimeMissing,
