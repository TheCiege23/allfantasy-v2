  ...
  return (
    ...
    >
      ...
      <p className="mt-1 text-xs leading-relaxed text-white/45">
        Advanced settings like waivers, rosters, trades, and playoffs can be customized in{' '}
        <span className="text-cyan-200/80">League Settings</span> after creation.
      </p>
      ...
      <div className="mt-5 rounded-2xl border border-white/[0.06] bg-white/[0.03] p-3 text-[11px] leading-relaxed text-white/40">
        Defaults for lineups, waivers, and draft clock are applied automatically. Chimmy and AI tools unlock from your
        league hub.
      </div>
    </aside>
  )
