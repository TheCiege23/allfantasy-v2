...
const translations: Record<string, Record<string, string>> = {
  en: {
    ...
    "home.products.bracket.primary": "Join Bracket Challenge",
    ...
    "home.products.legacy.body":
      "Access the original AllFantasy experience and continue where you left off.",
    "home.products.legacy.primary": "Enter Legacy",
  ...
  es: {
    ...
    "home.products.bracket.primary": "Unirse al Bracket Challenge",
    "home.products.bracket.signIn": "Iniciar sesión",
    "home.products.bracket.signUp": "Crear cuenta",

    "home.products.legacy.title": "AllFantasy Legacy",
    "home.products.legacy.body":
      "Accede a la experiencia original de AllFantasy y continúa donde la dejaste.",
    "home.products.legacy.primary": "Entrar a Legacy",
