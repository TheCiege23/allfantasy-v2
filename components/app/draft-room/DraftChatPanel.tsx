    ...
    <section className="flex flex-col overflow-hidden rounded-xl border border-white/12 bg-black/25">
      <div className="flex items-center justify-between gap-2 border-b border-white/10 px-3 py-2.5">
        <div className="flex items-center gap-2 min-w-0">
          ...
          {leagueChatSync && (
            <span className="rounded bg-cyan-500/20 px-1.5 py-0.5 text-[9px] text-cyan-300 shrink-0">
              League sync
            </span>
          )}
        </div>
        <div className="flex items-center gap-2 shrink-0">
          {onReconnect && (
            <button
              type="button"
              onClick={onReconnect}
              className="min-h-[44px] min-w-[44px] inline-flex items-center justify-center rounded-lg px-2 py-2 text-xs text-cyan-400 hover:bg-white/5 touch-manipulation"
          ...
          {isCommissioner && onBroadcast && (
            <button
              type="button"
              onClick={onBroadcast}
              className="min-h-[44px] inline-flex items-center gap-1.5 rounded-lg border border-amber-500/40 bg-amber-500/15 px-3 py-2 text-xs text-amber-200 hover:bg-amber-500/25 touch-manipulation"
      ...
      <div className="flex gap-2 border-t border-white/10 p-3 sm:p-2.5">
        <input
          type="text"
          value={input}
          ...
          disabled={disabled}
          className="flex-1 min-h-[44px] rounded-xl border border-white/15 bg-black/40 px-3 py-2.5 text-sm text-white placeholder:text-white/40 disabled:opacity-50 touch-manipulation"
        ...
        <button
          ...
          className="min-h-[44px] min-w-[44px] inline-flex items-center justify-center rounded-xl border border-cyan-500/40 bg-cyan-500/20 text-cyan-200 hover:bg-cyan-500/30 disabled:opacity-50 touch-manipulation"
