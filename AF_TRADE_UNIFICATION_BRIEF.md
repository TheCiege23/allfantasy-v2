...
- REMAINING candidates: Chimmy consuming replacement options; soccer/college schedule sources (blocked on ingestion coverage, not code); bench-swap deep-link into the lineup editor.
