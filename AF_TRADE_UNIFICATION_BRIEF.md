...
- REMAINING candidates: waiver-claim deep-link from replacement chips; Chimmy consuming replacement options; soccer/college schedule sources (blocked on ingestion coverage, not code).
