-- AllFantasy AI intelligence layer — platform learning tables
-- Apply after backups. Prisma models: see prisma/schema.prisma (AiPlatformEvent, etc.)
-- Idempotent: uses IF NOT EXISTS. No FKs (AllFantasy convention: app-level integrity).

CREATE EXTENSION IF NOT EXISTS pgcrypto;

-- Raw structured events (ingestion)
...
-- League archetype / format metrics
...
-- User tendencies (sport '' = all-sport bucket)
...
-- RLS: enable for Supabase API; Prisma direct connection typically bypasses RLS.
-- Uncomment to lock down PostgREST; adjust policies for your auth model.
-- ALTER TABLE ai_platform_events ENABLE ROW LEVEL SECURITY;
-- ALTER TABLE ai_player_market_metrics ENABLE ROW LEVEL SECURITY;
-- ALTER TABLE ai_league_type_metrics ENABLE ROW LEVEL SECURITY;
-- ALTER TABLE ai_user_tendencies ENABLE ROW LEVEL SECURITY;
-- ALTER TABLE ai_recommendation_outcomes ENABLE ROW LEVEL SECURITY;
-- ALTER TABLE ai_player_outlooks_cache ENABLE ROW LEVEL SECURITY;
