...
describe("root language provider layout", () => {
  ...
  it("uses the stable Next start path for Railway production", () => {
    ...
    expect(layoutSource).toContain('id="af-railway-styles"')
    expect(layoutSource).toContain("data-af-railway-styles")
    expect(layoutSource).toContain("RAILWAY_GIT_COMMIT_SHA")
