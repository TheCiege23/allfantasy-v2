...
export default async function LeaguePage({
  ...
  /* ââ Proactive env-var gate (matches dashboard/page.tsx) âââââââââââ */
  ...
  try {
    ...
    // My Leagues may use `SleeperLeague.id` when no unified `League` row exists yet â resolve to canonical League.
    if (!league) {
    ...
    // Let Next.js redirect() calls propagate â they throw internally.
