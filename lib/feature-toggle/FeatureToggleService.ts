...
const BOOLEAN_DEFAULTS: Record<string, boolean> = {
  ...
  [FEATURE_KEYS.CHIMMY_INTENT_CHIPS]: true,
  [FEATURE_KEYS.CHIMMY_ASSISTANT_MODES]: true,
  [FEATURE_KEYS.CHIMMY_FOLLOWUPS]: true,
  [FEATURE_KEYS.CHIMMY_TRUST_PANEL]: true,
  [FEATURE_KEYS.CHIMMY_DAILY_DIGEST]: false,
  [FEATURE_KEYS.CHIMMY_VOICE_PREVIEW]: false,
  [FEATURE_KEYS.CHIMMY_AI_KPI_EVENTS]: true,
