export const translations: Record<string, Record<string, string>> = {
  en: {
    ...
    "login.afterSignIn": "After sign in:",
    "login.destination.bracket": "NCAA Bracket",
    "login.destination.legacy": "AF Legacy",
    "login.destination.webapp": "AllFantasy WebApp",
    "login.destination.home": "AllFantasy Home",
    ...
    "landing.hero.headline": "The AI-Powered Fantasy Sports Platform",
    "landing.hero.subline": "Draft smarter. Trade better. Win more. One account for leagues, brackets, waivers, and AI tools across NFL, NBA, MLB, NHL, NCAA & Soccer.",
    ...
    "landing.final.heading": "Ready to dominate your league?",
    "landing.final.subheading": "Create your free account and get instant access to AI drafting, trade analysis, waiver picks, and bracket tools.",
  ...
  es: {
    ...
    "login.afterSignIn": "Después de iniciar sesión:",
    "login.destination.bracket": "NCAA Bracket",
    "login.destination.legacy": "AF Legacy",
    "login.destination.webapp": "AllFantasy WebApp",
    "login.destination.home": "Inicio de AllFantasy",
    ...
    // Landing page (universal)
    "landing.hero.headline": "La plataforma de fantasy sports impulsada por IA",
    "landing.hero.subline": "Draftea mejor. Intercambia mejor. Gana más. Una cuenta para ligas, brackets, waivers y herramientas IA para NFL, NBA, MLB, NHL, NCAA y Soccer.",
    ...
    "landing.final.heading": "¿Listo para dominar tu liga?",
    "landing.final.subheading": "Crea tu cuenta gratis y obtén acceso instantáneo a draft IA, análisis de trades, waivers y herramientas de bracket.",
