...
> = {
  ...
  matchup: { priority: "preferred", maxChars: 240 },
  roster: { priority: "preferred", maxChars: 520 },
...
const INTENT_SECTION_ALLOW: Record<ChimmyIntent, Set<string>> = {
  ...
  trade: new Set(["roster", "standings", "rankings", "leagueDifficulty"]),
  dynasty: new Set(["rankings", "leagueDifficulty", "standings"]),
