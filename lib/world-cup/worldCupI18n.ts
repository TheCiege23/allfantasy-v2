...
const EN: WorldCupDictionary = {
  ...
  "wc.chat.placeholder.dm": "DM Chat is coming soon for World Cup pools.",
  ...
  "wc.chat.dm.comingSoonTitle": "DM Chat coming soon",
  "wc.chat.dm.comingSoon": "Direct messages are not wired in the current World Cup MVP. Pool chat and private Chimmy replies remain available.",
...
const ES: WorldCupDictionary = {
  ...
  "wc.chat.placeholder.dm": "Chat DM estara disponible pronto para pools de World Cup.",
  ...
  "wc.chat.dm.comingSoonTitle": "Chat DM proximamente",
  "wc.chat.dm.comingSoon": "Los mensajes directos aun no estan conectados en el MVP de World Cup. El chat del pool y las respuestas privadas de Chimmy siguen disponibles.",
