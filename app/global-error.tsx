 ...
 *
 * Keep this fallback provider-free and document-root-free. On Railway, client
 * hydration can activate this boundary after the browser has already created an
 * implicit document element; returning document root tags from here then cascades into
