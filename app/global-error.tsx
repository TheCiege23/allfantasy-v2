 ...
 *
 * This is the ONLY boundary that catches errors thrown by the root `app/layout.tsx`
 * (and its providers). It must render its own <html> and <body> because it REPLACES
 * the failed root layout.
 *
