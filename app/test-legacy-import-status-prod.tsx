// Quick test page to view the raw API response for legacy import status in production.
import React, { useEffect, useState } from 'react';

export default function LegacyImportStatusProdTest() {
  ...
  return (
    <div style={{ padding: 32, background: '#181a20', color: '#fff', fontFamily: 'monospace' }}>
      <h2>Legacy Import Status API Test (Production)</h2>
