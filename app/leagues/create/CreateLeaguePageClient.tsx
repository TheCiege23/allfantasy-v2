...
function buildInitialState(): LeagueCreateFormState {
  ...
  return {
    ...
    survivorTieRule: 'revote_then_rocks',
    survivorRevealMode: 'dramatic_sequential',
    survivorChallengeMode: 'auto',
