/**
 * [NEW] app/api/commissioner/leagues/[leagueId]/mlb-schedule/route.ts
 * GET: Returns MLB schedule config + current week plan.
 * PUT: Updates MLB schedule config.
 */
...
export async function GET(
  ...
  try {
    previewPlan = await resolveMlbFantasyWeek({
      leagueId,
