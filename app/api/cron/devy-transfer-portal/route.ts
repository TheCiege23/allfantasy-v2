...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    console.error('[cron/devy-transfer-portal]', error)
    return NextResponse.json({ error: error instanceof Error ? error.message : 'Transfer portal refresh failed' }, { status: 500 })
  }
}
