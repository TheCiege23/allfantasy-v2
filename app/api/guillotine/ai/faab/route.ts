...
import { generateFaabRecommendations } from '@/lib/guillotine/ai/faabCoach'
...
export async function POST(req: NextRequest) {
  ...
  const out = await generateFaabRecommendations(body.rosterId, body.seasonId, body.scoringPeriod)
