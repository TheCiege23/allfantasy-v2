...
import { respondToZombieHordeSitOut } from '@/lib/zombie/ZombieHordeSitOutEngine'
...
export async function POST(
  ...
  return NextResponse.json({ ok: true, sitOutId: result.sitOutId, status: result.status })
}
