/**
 * PROMPT 3: Commissioner — revoke C2C promotion (back to PROMOTION_ELIGIBLE).
 */
...
import { c2CRevokePromotion } from '@/lib/merged-devy-c2c/promotion/C2CPromotionService'
...
export async function POST(
  ...
  const result = await c2CRevokePromotion({ leagueId, rightsId })
