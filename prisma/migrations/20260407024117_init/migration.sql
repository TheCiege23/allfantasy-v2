...
-- CreateEnum
CREATE TYPE "LeagueSport" AS ENUM ('NFL', 'NBA', 'MLB', 'NHL', 'NCAAF', 'NCAAB', 'SOCCER');
...
CREATE TABLE "LegacyImportJob" (
    ...
    "currentSeasonLeagues" INTEGER NOT NULL DEFAULT 0,
    "totalLeaguesSaved" INTEGER NOT NULL DEFAULT 0,
    "lastRankTier" TEXT,
    "lastRankLevel" INTEGER,
    "lastXpTotal" INTEGER NOT NULL DEFAULT 0,
    "notificationSent" BOOLEAN NOT NULL DEFAULT false,
    "seasonsSummary" JSONB NOT NULL DEFAULT '[]',
    "appUserId" TEXT,
...
-- CreateTable
CREATE TABLE "import_job_seasons" (
    "id" TEXT NOT NULL,
    "jobId" TEXT NOT NULL,
    "season" INTEGER NOT NULL,
...
-- CreateIndex
CREATE INDEX "LegacyImportJob_appUserId_status_idx" ON "LegacyImportJob"("appUserId", "status");

-- CreateIndex
CREATE INDEX "import_job_seasons_jobId_status_idx" ON "import_job_seasons"("jobId", "status");

-- CreateIndex
CREATE UNIQUE INDEX "import_job_seasons_jobId_season_key" ON "import_job_seasons"("jobId", "season");
...
-- AddForeignKey
ALTER TABLE "LegacyImportJob" ADD CONSTRAINT "LegacyImportJob_appUserId_fkey" FOREIGN KEY ("appUserId") REFERENCES "app_users"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "import_job_seasons" ADD CONSTRAINT "import_job_seasons_jobId_fkey" FOREIGN KEY ("jobId") REFERENCES "LegacyImportJob"("id") ON DELETE CASCADE ON UPDATE CASCADE;
